...
{
    public class Db4oUserRepository: IUserRepository
    {
        private readonly IObjectServer server;
        private readonly IObjectContainer client;
        private readonly object userLock;

        public Db4oUserRepository(): this(IOHelper.MakeAbsolute(ConfigurationManager.AppSettings["userRepository.path.db4o"])){}
